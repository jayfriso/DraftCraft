...
bool CardView::init()
{
    ...
    UIUtils::setAnchoredPosition(m_frontContainer, AnchorPosition::CenterCenter);
    ...
    UIUtils::setAnchoredPosition(manaBg, AnchorPosition::TopLeft, Vec2{ 10,-10 });
    ...
    UIUtils::setAnchoredPosition(m_manaValueLabel, AnchorPosition::CenterCenter);

    m_attackValueContainer = Sprite::create("ui/card/attack_icon.png");
    m_frontContainer->addChild(m_attackValueContainer, 2);
    UIUtils::setAnchoredPosition(m_attackValueContainer, AnchorPosition::BottomLeft, Vec2{ 10,10 });
    ...
    UIUtils::setAnchoredPosition(m_defenseValueContainer, AnchorPosition::BottomRight, Vec2{ -10,10 });
    ...
    UIUtils::setAnchoredPosition(m_cardArtSprite, AnchorPosition::TopCenter, Vec2{ 0,-50 });
    m_cardArtSprite->setContentSize(Size{ 490, 333 });

    auto cardTextBg = UIUtils::createGenericRoundedRect(Size{ 490, 355 }, Color3B::WHITE);
    m_frontContainer->addChild(cardTextBg, 1);
    UIUtils::setAnchoredPosition(cardTextBg, AnchorPosition::BottomCenter, Vec2{ 0, 50 });;
    ...
    UIUtils::setAnchoredPosition(m_cardTextLabel, AnchorPosition::TopCenter, Vec2{ 0, -50 });;

    auto nameBg = Sprite::create("ui/card/card_name_bg.png");
    m_frontContainer->addChild(nameBg, 2);
    UIUtils::setAnchoredPosition(nameBg, AnchorPosition::TopCenter, Vec2{ 0, -340 });;
    ...
    UIUtils::setAnchoredPosition(m_nameContainer, AnchorPosition::CenterCenter);;

    m_backSprite = Sprite::create("ui/card/card_back.png");
    addChild(m_backSprite, 0);
    UIUtils::setAnchoredPosition(m_backSprite, AnchorPosition::CenterCenter);;
